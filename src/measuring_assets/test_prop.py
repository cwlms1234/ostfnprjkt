...
def produce_test_log(config):  # python -c 'from src.measuring_assets.test_prop import produce_test_log; produce_test_log()'  # noqa: E501
    ...
    while time_cursor < timestamp:
        ...
        write_to_file(
            config,(time_cursor, temp_measure),
        )
